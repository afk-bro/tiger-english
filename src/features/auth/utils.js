...
import { ERROR_MESSAGES, ERROR_FIELD_MAPPING, SUPABASE_ERROR_CODES, ERROR_KEYWORDS } from './constants';
...
export async function cleanupAuthUser(userId) {
    try {
...
export function checkUserAlreadyExists(user, data) {
