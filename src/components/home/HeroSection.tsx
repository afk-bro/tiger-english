    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative text-center py-24 md:py-32 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-bold leading-tight mb-6 bg-gradient-to-r from-primary-300 to-[#fcd34d] font-display bg-clip-text text-transparent tracking-wide">
            {t("hero.title")}
          </h1>
