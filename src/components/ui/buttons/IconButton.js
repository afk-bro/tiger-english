...
export const IconButton = forwardRef(({ icon, onClick, disabled = false, 'aria-label': ariaLabel, className = '', size = 'md', type = 'button' }, ref) => {
    ...
    return (_jsx("button", { ref: ref, type: type, onClick: onClick, disabled: disabled, "aria-label": ariaLabel, className: clsx(baseClasses, sizeClasses[size], styleClasses, disabledClasses, className), children: icon }));
});
